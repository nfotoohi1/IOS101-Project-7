...
extension Task {
    ...
    static func save(_ tasks: [Task]) {
        // TODO: Save the array of tasks [x]
    ...
    static func getTasks() -> [Task] {
        // TODO: Get the array of saved tasks from UserDefaults [x]
        if let encoded = defaults.data(forKey: "tasks"){
